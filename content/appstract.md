...
**B2C:** Shoppers on partner sites don't notice or understand the widget. The value proposition of shopping being better when shared isn't landing at the moment of use.
...
4. Respect the host environment. The widget is a guest on someone else's site and should integrate without disrupting.
